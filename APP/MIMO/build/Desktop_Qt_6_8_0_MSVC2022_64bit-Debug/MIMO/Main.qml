...
ApplicationWindow {
    ...
    SwipeView {
        ...
        Page {
            ...
            Rectangle {
                ...
                height: parent.parent.height - topArea.height - bottomArea.height
                anchors {
                    top: topArea.bottom
                    bottom: bottomArea.top
                    left: parent.left
    ...
    Rectangle {
        ...
        property int longPressThreshold: 800 // 长按时间阈值（毫秒）
        property int noAudioTimeout: 5000 // 无音频输入超时（毫秒）
        ...
        MouseArea {
            ...
            Timer {
                id: longPressTimer
                interval: longPressThreshold  // 长按1秒触发
                onTriggered: {
                    aiCall.isLongPressed = true
                    swipeView.currentIndex = 1  // 跳转音视频界面
                    //startAudioDetection()
                }
            }
        }
